      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            content: "Under the GDPR, you have the right to:\n\n• **Access** your personal data.\n• **Rectify** inaccurate data.\n• **Erase** your data (\"right to be forgotten\").\n• **Restrict** processing.\n• **Data portability**.\n• **Object** to processing.\n• **Withdraw consent** at any time.\n\nTo exercise these rights, contact us at {{LEGAL_EMAIL}}. You also have the right to lodge a complaint with your local Data Protection Authority.",
          },
          {
            heading: "8. Security",
      ...
      terms: {
        ...
        sections: [
          ...
          },
          {
            ...
            content: "These Terms shall be governed by and construed in accordance with the laws of {{LEGAL_JURISDICTION}}. Any disputes arising from the use of this Service shall be subject to the exclusive jurisdiction of the courts of {{LEGAL_JURISDICTION}}.",
          },
          {
            heading: "10. Contact",
            content: "For questions about these Terms of Service, contact us at {{LEGAL_EMAIL}}.",
          },
        ],
      },
      cookies: {
        ...
        sections: [
          ...
          {
            heading: "7. Contact",
            content: "For questions about our use of cookies, contact us at {{LEGAL_EMAIL}}.",
          },
        ],
      },
      legalNotice: {
        ...
        sections: [
          ...
          },
          {
            ...
            content: "This legal notice is governed by {{LEGAL_JURISDICTION}} law. For any disputes, the parties agree to submit to the courts of {{LEGAL_JURISDICTION}}, except where consumer protection law requires otherwise.",
          },
        ],
      },
    },
  ...
  es: {
    ...
    legal: {
      privacy: {
        ...
        description: "Política de Privacidad de BizDays Global. Conoce cómo recogemos, usamos y protegemos tus datos personales.",
        ...
        sections: [
          ...
          },
          {
            ...
            content: "Según el RGPD, tienes derecho a:\n\n• **Acceder** a tus datos personales.\n• **Rectificar** datos inexactos.\n• **Suprimir** tus datos (\"derecho al olvido\").\n• **Limitar** el tratamiento.\n• **Portabilidad** de datos.\n• **Oponerte** al tratamiento.\n• **Retirar el consentimiento** en cualquier momento.\n\nPara ejercer estos derechos, contáctanos en {{LEGAL_EMAIL}}. También tienes derecho a presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD).",
          },
          {
            heading: "8. Seguridad",
            content: "Implementamos medidas técnicas y organizativas apropiadas para proteger tus datos personales, incluyendo cifrado HTTPS, infraestructura de alojamiento segura y controles de acceso.",
          },
          {
            heading: "9. Privacidad de Menores",
            content: "BizDays Global no está dirigido a menores de 16 años. No recopilamos datos de menores de forma consciente.",
          },
          {
            heading: "10. Cambios en esta Política",
            content: "Podemos actualizar esta Política de Privacidad periódicamente. Los cambios se publicarán en esta página con una fecha de revisión actualizada. Te recomendamos revisar esta política periódicamente.",
          },
        ],
      },
      terms: {
        title: "Términos del Servicio",
        description: "Términos del Servicio de BizDays Global. Lee las condiciones de uso de nuestra calculadora de días laborables.",
        lastUpdated: "Última actualización: {{DATE}}",
        sections: [
          {
            heading: "1. Aceptación de los Términos",
            content: "Al acceder y utilizar BizDays Global (el \"Servicio\"), aceptas quedar vinculado por estos Términos del Servicio. Si no estás de acuerdo con estos términos, por favor no utilices el Servicio.",
          },
          {
            heading: "2. Descripción del Servicio",
            content: "BizDays Global es una herramienta online gratuita que calcula días laborables (días hábiles) excluyendo fines de semana y festivos públicos de países de todo el mundo. El Servicio se proporciona \"tal cual\" y está destinado únicamente a fines informativos y de planificación.",
          },
          {
            heading: "3. Descargo de Responsabilidad sobre Exactitud",
            content: "Aunque nos esforzamos por proporcionar datos de festivos precisos, NO garantizamos la exactitud, integridad o actualidad de la información proporcionada. Los datos de festivos provienen de bases de datos de código abierto y pueden no reflejar:\n\n• Festivos regionales o locales.\n• Cambios de última hora en los calendarios festivos por parte de los gobiernos.\n• Días no laborables específicos de determinados sectores.\n\n**Siempre debes verificar las fechas críticas con las autoridades locales o fuentes oficiales antes de tomar decisiones empresariales.**",
          },
          {
            heading: "4. Limitación de Responsabilidad",
            content: "En la máxima medida permitida por la ley, BizDays Global y sus operadores no serán responsables de ningún daño directo, indirecto, incidental, especial, consecuente o punitivo derivado de:\n\n• El uso o la imposibilidad de uso del Servicio.\n• Errores o inexactitudes en los cálculos.\n• Decisiones empresariales tomadas basándose en los resultados del Servicio.\n• Interrupciones del Servicio.",
          },
          {
            heading: "5. Propiedad Intelectual",
            content: "El nombre, logotipo, diseño y contenido original de BizDays Global son propiedad de sus respectivos titulares. El código fuente está disponible bajo licencia de código abierto. Las librerías de terceros utilizadas conservan sus respectivas licencias.",
          },
          {
          ...
          },
          {
            ...
            content: "El Servicio puede contener enlaces a sitios web de terceros y mostrar publicidad (incluyendo Google AdSense y enlaces de socios afiliados). No somos responsables del contenido, prácticas de privacidad o términos de sitios de terceros.",
          },
          {
            heading: "8. Modificaciones",
            content: "Nos reservamos el derecho de modificar, suspender o interrumpir el Servicio (o cualquier parte del mismo) en cualquier momento sin previo aviso. También podemos actualizar estos Términos del Servicio periódicamente. El uso continuado del Servicio constituye la aceptación de los términos actualizados.",
          },
          {
            heading: "9. Ley Aplicable",
            content: "Estos Términos se regirán e interpretarán de acuerdo con las leyes de {{LEGAL_JURISDICTION}}. Cualquier disputa derivada del uso de este Servicio estará sujeta a la jurisdicción exclusiva de los tribunales de {{LEGAL_JURISDICTION}}.",
          },
          {
            heading: "10. Contacto",
            content: "Para preguntas sobre estos Términos del Servicio, contáctanos en {{LEGAL_EMAIL}}.",
          },
        ],
      },
      cookies: {
        title: "Política de Cookies",
        description: "Política de Cookies de BizDays Global. Conoce qué cookies usamos y cómo gestionarlas.",
        lastUpdated: "Última actualización: {{DATE}}",
        sections: [
          {
            heading: "1. ¿Qué son las Cookies?",
            content: "Las cookies son pequeños archivos de texto que se almacenan en tu dispositivo cuando visitas un sitio web. Ayudan a que los sitios funcionen correctamente, recuerden preferencias y proporcionen funciones de análisis y publicidad.",
          },
          {
          ...
          },
          {
            ...
            content: "Cuando visitas BizDays Global por primera vez, te pediremos tu consentimiento antes de colocar cookies no esenciales. Puedes cambiar tus preferencias en cualquier momento a través de nuestro panel de configuración de cookies.\n\nLas cookies esenciales no requieren consentimiento ya que son necesarias para el funcionamiento del sitio web.",
          },
          {
            heading: "4. Gestión de Cookies",
            content: "Puedes gestionar las cookies a través de:\n\n• **Nuestra configuración de cookies**: Usa el panel de preferencias de cookies en nuestro sitio.\n• **Configuración del navegador**: La mayoría de los navegadores permiten bloquear o eliminar cookies.\n• **Configuración de anuncios de Google**: Gestiona la personalización en [adssettings.google.com](https://adssettings.google.com).\n\nNota: Bloquear las cookies puede afectar al funcionamiento del sitio web.",
          },
          {
            heading: "5. Duración de las Cookies",
            content: "• **Cookies de sesión**: Se eliminan al cerrar el navegador.\n• **Cookies persistentes**: Permanecen en tu dispositivo durante un período determinado (normalmente 1-24 meses) o hasta que se eliminen manualmente.\n• **Cookies de Google Analytics**: Hasta 26 meses.",
          },
          {
            heading: "6. Cambios en esta Política",
            content: "Podemos actualizar esta Política de Cookies para reflejar cambios en las cookies que utilizamos o por motivos legales. Consulta esta página periódicamente.",
          },
          {
            heading: "7. Contacto",
            content: "Para preguntas sobre nuestro uso de cookies, contáctanos en {{LEGAL_EMAIL}}.",
          },
        ],
      },
      legalNotice: {
        title: "Aviso Legal",
        description: "Aviso Legal de BizDays Global. Información sobre la titularidad del sitio web e información legal.",
        lastUpdated: "Última actualización: {{DATE}}",
        sections: [
          {
            heading: "1. Titular del Sitio Web",
            content: "En cumplimiento del deber de información recogido en el artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSI-CE), se facilitan los siguientes datos:\n\n• **Titular**: {{LEGAL_NAME}}\n• **NIF/CIF**: {{LEGAL_TAX_ID}}\n• **Domicilio**: {{LEGAL_ADDRESS}}\n• **Email**: {{LEGAL_EMAIL}}\n• **Sitio web**: {{SITE_URL}}",
          },
          {
            heading: "2. Objeto del Sitio Web",
            content: "BizDays Global es un sitio web informativo que proporciona una herramienta de cálculo de días laborables online. El sitio web se monetiza mediante publicidad online (Google AdSense) y programas de marketing de afiliación.",
          },
          {
            heading: "3. Propiedad Intelectual",
            content: "Todo el contenido de este sitio web, incluyendo pero no limitado a textos, gráficos, logotipos, iconos, imágenes y software, es propiedad de BizDays Global o de sus proveedores de contenido y está protegido por las leyes internacionales de propiedad intelectual.\n\nEl código fuente de código abierto que alimenta esta aplicación está disponible bajo los términos de su respectiva licencia.",
          },
          {
            heading: "4. Limitación de Responsabilidad",
          ...
          },
          {
            ...
            content: "El presente aviso legal se rige por la legislación de {{LEGAL_JURISDICTION}}. Para cualquier controversia, las partes se someten a los juzgados y tribunales de {{LEGAL_JURISDICTION}}, salvo que la normativa de protección al consumidor disponga otra cosa.",
          },
        ],
      },
    },
    contact: {
      title: "Contacto",
      description: "Ponte en contacto con el equipo de BizDays Global. Nos encantaría saber de ti.",
      subtitle: "¿Tienes alguna pregunta, sugerencia o consulta comercial? Nos encantaría saber de ti.",
      form: {
        name: "Tu Nombre",
        email: "Tu Email",
        subject: "Asunto",
        ...
        successMessage: "¡Gracias! Tu mensaje ha sido enviado. Te responderemos en un plazo de 48 horas.",
      },
      info: {
